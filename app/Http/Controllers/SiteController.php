...
class SiteController extends Controller
{
    ...
    public function storeContact(Request $request)
    {
        ...
        // Concatenate the selected marketplaces into a comma-separated string
        $marketplaces = $request->marketplaces ? implode(', ', $request->marketplaces) : null;

        // Debugging: Log the marketplaces to ensure data is being received correctly
