                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="select2 form-control" name="category_id">
                                                                    <option value="{{ $sub_category->category_id }}">
                                                        ...
                                                        <div class="col-md-12 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea type="text" id="sub_title" class="form-control" name="sub_title" rows="5" cols="20"
                                                                    value="{{ old('sub_title', $sub_category->sub_title) }}">{{ old('sub_title', $sub_category->sub_title) }}</textarea>
                                                            </div>
                                                        </div>
