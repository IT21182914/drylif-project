    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                @endif
                <a href="{{ route('sub_category_service.create') }}" class="btn btn-primary float-right">Add Sub Category</a>
                        ...
                        <tbody>
                            @foreach ($sub_category_services as $index => $sub_category_service)
                                <tr>
                                    ...
                                    <td>{{ $sub_category_service->name }}</td>
                                    <td>
                                        <form
                                            action="{{ route('sub_category_service.destroy', $sub_category_service->id) }}"
                                            method="POST">
                                            <a href="{{ route('sub_category_service.edit', $sub_category_service->id) }}"><i
