                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-name">Create New Sub Category</h4>
                                    </div>
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form"
                                                action="{{ route('sub_category_service.update', $sub_category_service->id) }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-12">
                                                            <div class="form-group">
                                                                <label for="name">Sub Category Service Name</label>
                                                                <input type="text" id="name" class="form-control"
                                                                    value="{{ old('name', $sub_category_service->name) }}"
                                                                    placeholder="Enter Sub Category Service Name Text"
                                                                    name="name">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="select2 form-control" name="sub_category_id">
                                                                    <option
                                                                        value="{{ $sub_category_service->sub_category_id }}">
                                                                        @foreach ($sub_categories as $sub_category)
                                                                            @if ($sub_category->id == $sub_category_service->sub_category_id)
                                                                                {{ $sub_category->title }}
                                                                            @endif
                                                                        @endforeach
                                                                    </option>
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <img id="imagePreview1"
                                                                    src="{{ asset($sub_category_service->image) }}"
                                                                    alt="Image Preview"
                                                        ...
                                                        <div class="col-md-12 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea type="text" id="sub_title" class="form-control" name="paragraph" rows="5" cols="20"
                                                                    value="{{ old('paragraph', $sub_category_service->paragraph) }}">{{ old('paragraph', $sub_category_service->paragraph) }}</textarea>
                                                            </div>
                                                        </div>
