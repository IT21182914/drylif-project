                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form"
                                                action="{{ route('testimonial.update', $testimonial->id) }}" method="POST"
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <img id="imagePreview2"
                                                                    src="{{ asset($testimonial->client_pic) }}"
                                                                    alt="Image Preview"
                                                                    style="width: 30%; height: 30%; object-fit: cover;"><br>
                                                        ...
                                                        <div class="col-md-12 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea type="text" id="feedback" class="form-control" name="feedback" rows="5" cols="20"
                                                                    value="{{ old('feedback') }}">{{ old('feedback', $testimonial->feedback) }}</textarea>
                                                            </div>
                                                        </div>
